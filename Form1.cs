...
namespace FileBatchPrinterGUI
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void SetupUI()
        {
            ...
            lblSelectedCount = new Label { Text = "已选择 0 个文件", Location = new Point(100, bottomY + 2), Size = new Size(120, 23) };
            lblAuthorVersion = new Label { Text = "作者:王国强 Rev.A01", Location = new Point(230, bottomY + 2), Size = new Size(150, 23), ForeColor = Color.DarkBlue, Font = new Font("Segoe UI", 9, FontStyle.Bold) };

            DateTime expireDate = _currentLicense?.ExpireDate ?? DateTime.Today.AddDays(30);
            lblExpireDate = new Label { Text = $"授权至:{expireDate:yyyy-MM-dd}", Location = new Point(400, bottomY + 2), Size = new Size(120, 23), ForeColor = Color.Red };
            ...
            this.Controls.AddRange(new Control[] { lblDir, txtDirectory, btnScan, lblSearch, txtSearch, btnSearch, lblFiles, lblEmail, clbFiles, btnSelectAll, lblSelectedCount, lblAuthorVersion, lblExpireDate, btnPrint, lblStatus });
        }
